...
public class SimpleGestureDetector //: iGestureDetector
{
    ...
    public TouchRes GetGesture(Touch[] touches)
    {
        foreach (var touch in Input.touches)
        {
            int value = DetermineTouchGesture(touch);
            touchRes = new TouchRes(0, value, registeredTouches);
        }
        return touchRes;
