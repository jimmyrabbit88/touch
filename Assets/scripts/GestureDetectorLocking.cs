...
public class GestureDetectorLocking : i_GestureDetector
{
    private Touch[] beginTouch = new Touch[10];
    private float[] startTime = new float[10];

    public List<TouchResult> touchGestureList = new List<TouchResult>();

    private int itor = 0;

    public List<TouchResult> GetGesture(Touch[] touches)
    {
        ...
        {
            TouchResult foundGesture = touchGestureList.Find(i => i.FingerId == touch.fingerId);
    ...
    private void AddToLockedGestureList(Touch touch, int gesture)
    {
        ...
        tl.Add(touch);
        touchGestureList.Add(new TouchResult(touch.fingerId, gesture, tl));
    }
    ...
    public List<TouchResult> UpdateListTouches(Touch touch, Touch linkTouch)
    {
